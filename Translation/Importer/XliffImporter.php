 ...
 */
class XliffImporter extends ContainerAware implements ImporterInterface
{
    /**
     * {{@inheritdoc}}
     */
     ...
     * {{@inheritdoc}}
     */
    public function importFile(Bundle $bundle, LocaleInterface $locale, $translationFile)
    {
        ...
        // Loading file
        $xliff        = simplexml_load_file($translationFile);
